...
<div>
    <div align="center">
        <h1 align="center">Welcome you for License page!!</h1><br>
        <form action="lic" method="get">
            ...
            License For <input type="text" placeholder="Enter License for" name="license"/><br><br>
